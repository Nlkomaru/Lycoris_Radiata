...
dependencies {
    ...
    transitiveInclude(implementation("com.github.shynixn.mccoroutine:mccoroutine-fabric-api:2.14.0")!!)
    transitiveInclude(implementation("com.github.shynixn.mccoroutine:mccoroutine-fabric-core:2.15.0")!!)
